...
def calc_rectangle_area():
    '''This function calculates the area of a rectangle. It asks the user for
    the required measurements and what units they want to use, it makes sure 
    to validate each input and then asks the user for another if it's invalid.
    Then the rectangle's area is calculated from those variables.
    '''
    print(f'\n☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲'
          f'☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲'
          f'☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲')
...
def calc_square_area():
    ...
    the required measurements and what units they want to use, it makes sure 
    to validate each input and then asks the user for another if it's invalid.
    Then the square's area is calculated from those variables.
    '''
    print(f'\n☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲'
          f'☲☲☲☲☲☲☲☲☲☲☲☲☲'
          f'☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲☲'
